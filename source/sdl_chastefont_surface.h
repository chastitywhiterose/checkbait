...
/*
this uses direct pixel access of the source font surface to draw only when the source pixel is not black. But this one scales and draws the text in the color passed to this function!
*/
